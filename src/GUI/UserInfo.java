...
public class UserInfo extends javax.swing.JFrame {
    ...
    public UserInfo() {
        initComponents();
        ViewAlluserInfo x=new ViewAlluserInfo(jTable1);
    }
    LinkedList<CarInfo1> c;
    ArrayList<UserData1> u;
    public UserInfo(LinkedList l,ArrayList a) {
        initComponents();
        c=l;
        u=a;
        ViewAlluserInfo x=new ViewAlluserInfo(jTable1);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 0, 1600, 121);
        ...
        jButton1.setBounds(927, 289, 75, 31);
